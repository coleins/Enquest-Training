...
| **Service Gratuity (D)**    | A lump-sum or periodic benefit paid (e.g., at end of service or contract renewal).                                                             | — _(Manually entered/System generated(depending on clients formula))_        |
